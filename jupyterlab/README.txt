Welcome to your MatrixDS Jupyter Lab tool. 
...
There a lot of great things you can do from this tool. All common data science libraries are pre-installed for you. Also, when using the terminal from within Jupyter available command line clients include:
